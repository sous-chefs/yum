...
default['yum']['main']['errorlevel'] = nil
...
default['yum']['main']['gpgcheck'] = true
...
default['yum']['main']['skip_broken'] = nil
default['yum']['main']['assumeyes'] = nil
default['yum']['main']['alwaysprompt'] = nil
default['yum']['main']['tolerant'] = false
default['yum']['main']['exclude'] = false
default['yum']['main']['exactarch'] = nil # [TrueClass, Falseclass]
default['yum']['main']['installonlypkgs'] = true # /.*/
default['yum']['main']['installonly_limit'] = '3'
...
default['yum']['main']['sslverify'] = nil # /.*/
...
default['yum']['main']['clean_requirements_on_remove'] = nil #  /.*/
