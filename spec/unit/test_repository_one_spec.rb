...
describe 'yum_test::test_repository_one' do
  ...
  let(:test_repository_one_clean) do
    test_repository_one_run.execute('yum clean test1')
  end
...
'
  ...
  context 'creating a yum_repository with minimal parameters' do
    ...
    it 'cleans the headers of the yum repository for test1' do
      expect(test_repository_one_clean.command).to eq('yum clean headers --disablerepo=* --enablerepo=test1')
    end
