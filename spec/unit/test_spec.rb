...
username=baub'
  ...
  let(:baseurl_gpgkey_array_test_content) do
    '# This file was generated by Chef for chefspec.local
# Do NOT modify this file by hand.

[baseurl-gpgkey-array-test]
name=baseurl/gpgkey array test
baseurl=http://a.b.c
  http://d.e.f
enabled=1
gpgcheck=1
gpgkey=http://a.b.c/RPM-GPG-KEY-a
  http://d.e.f/RPM-GPG-KEY-b
sslverify=1
'
  end
  ...
  context 'creating a yum_repository with :baseurl and :gpgkey as arrays' do
    it 'creates yum_repository[baseurl-gpgkey-array-test]' do
      expect(chef_run).to create_yum_repository('baseurl-gpgkey-array-test')
    end

    it 'steps into yum_repository and creates template[/etc/yum.repos.d/baseurl-gpgkey-array-test.repo]' do
      expect(chef_run).to render_file('/etc/yum.repos.d/baseurl-gpgkey-array-test.repo').with_content(baseurl_gpgkey_array_test_content)
    end
  end
