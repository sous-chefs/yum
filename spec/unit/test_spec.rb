...
'
  ...
  context 'creating a yum_repository with no :gpgcheck and :gpgkey attributes' do
    it 'adds yum_repository[test9a]' do
      expect(chef_run).to render_file('/etc/yum.repos.d/test9a.repo').with_content(test9a_content)
    end
  end

  context 'creating a yum_repository with :gpgkey but no :gpgkey' do
    it 'adds yum_repository[test9b]' do
      expect(chef_run).to render_file('/etc/yum.repos.d/test9b.repo').with_content(test9b_content)
    end
  end

  context 'creating a yum_repository with :gpgcheck but no :gpgkey' do
    it 'adds yum_repository[test9c]' do
      expect(chef_run).to render_file('/etc/yum.repos.d/test9c.repo').with_content(test9c_content)
    end
  end

  context 'creating a yum_repository with :gpgcheck and :gpgkey' do
    it 'adds yum_repository[test9d]' do
      expect(chef_run).to render_file('/etc/yum.repos.d/test9d.repo').with_content(test9d_content)
    end
  end
