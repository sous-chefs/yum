# Encoding: utf-8
#
# Author:: Kosuke Arisawa (<arisawa@gmail.com>)
# Cookbook Name:: yum
# Recipe:: epel-testing
#
...
yum_repository 'epel-testing' do
  description 'Extra-Testing Packages for Enterprise Linux'
  key node['yum']['epel']['key']
  url node['yum']['epel']['baseurl']
  mirrorlist node['yum']['epel-testing']['url']
  includepkgs node['yum']['epel']['includepkgs']
  exclude node['yum']['epel']['exclude']
  enabled node['yum']['epel-testing']['enabled']
